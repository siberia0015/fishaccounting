...
/**
 * DAO for table "FISH_PAY".
 */
public class FishPayDao extends AbstractDao<FishPay, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, FishPay entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FishPay entity) {
        stmt.clearBindings();
    ...
    @Override
    public FishPay readEntity(Cursor cursor, int offset) {
        FishPay entity = new FishPay( //
    ...
    @Override
    public void readEntity(Cursor cursor, FishPay entity, int offset) {
    ...
    /**
     * Properties of entity FishPay.<br/>
