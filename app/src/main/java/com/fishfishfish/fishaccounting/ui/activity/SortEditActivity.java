...
import com.fishfishfish.fishaccounting.ui.adapter.SortEditAdapter;
...
public class SortEditActivity extends BaseActivity implements NoteView {
    ...
    @Override
    public void loadDataSuccess(FishSort tData) {
        ProgressUtils.dismiss();
    }

    @Override
    public void loadDataSuccess(FishPay tData) {
        ProgressUtils.dismiss();
    }
...
//                            presenter.addSort(currentUser.getId(), input, "sort_tianjiade.png", !isOutcome);
                            FishSort sort = new FishSort(null, input, "sort_tianjiade.png", 0, !isOutcome);
