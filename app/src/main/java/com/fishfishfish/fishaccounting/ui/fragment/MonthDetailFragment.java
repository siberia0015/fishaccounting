package com.fishfishfish.fishaccounting.ui.fragment;
...
public class MonthDetailFragment extends BaseFragment implements MonthDetailView {
    ...
    protected void initEventAndData() {
        ...
        adapter.setOnStickyHeaderClickListener(new MonthDetailAdapter.OnStickyHeaderClickListener() {
            @Override
            public void OnDeleteClick(FishBill item, int section, int offset) {
                item.setVersion(-1);
            ...
            @Override
            public void OnEditClick(FishBill item, int section, int offset) {
