...
public class BillAddActivity extends BaseActivity implements BillView {
    ...
    protected List<FishSort> mDatas;
    ...
    protected void initViewPager() {
        ...
        List<FishSort> tempData = new ArrayList<>();
        tempData.addAll(mDatas);
        //末尾加上添加选项
        tempData.add(new FishSort(null, "添加", "sort_tianjia.png", 0, null));
    ...
    public void doCommit() {
        ...
        FishBill fishBill = new FishBill(null, null, Float.valueOf(num + dotNum), remarkInput, currentUser.getObjectId(),
